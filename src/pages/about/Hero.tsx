  ...
  return (
    <div className="relative w-full h-[300px] md:h-[550px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-[16px] md:px-[80px]">
        <div className="">
          <h1 className=" md:mt-[0px] text-white font-medium text-[24px] md:text-[56px] leading-tight md:leading-[68px]">
            Pioneering Cable Manufacturing
          </h1>
          <h1 className="text-white font-medium text-[24px] md:text-[56px] leading-tight">
