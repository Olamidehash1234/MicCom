export default function HeroComponent() {
  return (
    <div className="relative w-full h-[300px] md:h-[500px] overflow-hidden">
      ...
      {/* Text Content */}
      <div className="absolute inset-0 flex flex-col justify-center px-[16px] sm:px-12 md:px-[80px]">
        <div className="">
          <h1 className="text-white font-medium text-[36px] md:text-[56px] leading-tight md:leading-[68px]">
